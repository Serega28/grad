                                    ...
                                    <div class="indent-left">
                                        ...
                                        <?php endif; ?>
                                            <div class="signup-form"><!--sign up form-->
                                                <h4 class="p1">Введите свои данные:</h4>
                                                <form id="contact-form" action="#" method="post" enctype="multipart/form-data">
                                                    <fieldset>
                                                        <label><input type="text" name="name" placeholder="Имя" value="<?php echo $name; ?>"/></label><br>
                                                        ...
                                                        <label><input type="submit" name="submit" class="btn btn-default" value="Регистрация" /></label><br>
                                                    </fieldset>
                                                </form>
                                            </div><!--/sign up form-->
                                         <?php endif; ?>
