                                    ...
                                    <article class="grid_8">
                                        <div class="indent-left">
                                            <div class="wrapper border-bot2">
                                                <figure class="img-indent2"><img src="/template/images/page2-img1.png" alt=""></figure>
                                                <div class="extra-wrap"> <strong class="text-1">Facebook</strong> <strong class="text-1">Fan Page</strong>
                                            ...
                                            <div class="wrapper img-indent-bot">
                                                <figure class="img-indent3"><img src="/template/images/page2-img2.png" alt=""></figure>
                                                <div class="extra-wrap">
                                                    ...
                                                    <p>At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna.<br><br><br></p>
                                                </div>
                                                ...
                                                <div class="wrapper">
                                                    <div class="col-1">
                                                        <figure class="indent-bot"><a href="#"><img src="/template/images/page2-img3.png" alt=""></a></figure>
                                                    ...
                                                    <div class="col-1">
                                                        <figure class="indent-bot"><a href="#"><img src="/template/images/page2-img4.png" alt=""></a></figure>
                                                        <h6><strong>William Torn</strong></h6>
                                                        Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor. </div>
                                                    <div class="col-2">
                                                        <figure class="indent-bot"><a href="#"><img src="/template/images/page2-img5.png" alt=""></a></figure>
                                        ...
                                        <div class="indent-left2 indent-top">
                                            ...
                                            <div class="indent-left">
                                                ...
                                                <ul class="list-1">
                                                    ...
                                                    <li>Amet consetetur sadipscing</li>
                                                    <li>Sed diam nonumy eirmod</li>
                                                    <li>Tempor invidunt</li>
                                                    <li>Labore et dolore magna</li>
                                                    <li>Aliquyam erat sed</li>
                                                    <li>Diam voluptua vero eos et</li>
                                                    <li>Accusam et justo duo</li>
